			...
			<table class="table table-hover m-3">
				...
				<c:forEach var="mainVO" items="${mainVOS}">
					<tr class="text-center">
						...
						<td>
							<input type="button" value="삭제" onclick="categoryMainDelete('${mainVO.categoryMainCode}')" class="btn btn-danger btn-sm" />
						</td>
					</tr>
				</c:forEach>
				<tr>
			...
			<table class="table table-hover m-3">
				...
				<c:forEach var="middleVO" items="${middleVOS}">
					<tr class="text-center">
						...
						<td>
							<input type="button" value="삭제" onclick="categoryMiddleDelete('${middleVO.categoryMiddleCode}')" class="btn btn-danger btn-sm" />
						</td>
					</tr>
				</c:forEach>
				<tr>
